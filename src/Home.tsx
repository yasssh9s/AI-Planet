...
const Home = () => {
  return (
    <div>
      <div className="w-full h-full bg-[#003145] flex justify-center gap-20 p-28 text-white tracking-widest">
        <div className="w-3/5 flex flex-col gap-10">
          <h1 className="text-5xl font-bold border-l-[10px] border-[#FFCE5C] px-10">
            Accelerate Innovation <br /> with Global AI Challenges
          </h1>
          <div className="ml-10">
            <p className="w-[80%] text-lg font-light mb-10">
            ...
            {/* <Button variant="light" className="font-bold text-lg p-2"> */}
            <Link
              to="/create-hackathon"
      ...
      {/* Trio */}
      <div className="bg-[#002A3B] text-white flex items-center justify-center gap-20 px-10 py-14">
